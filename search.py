...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        x+=1
        if problem.goal_test(node.state):
            print "Nodos expandidos: ", x
            return node
        """QUITAR LA LISTA CERRADA PARA LOS METODOS DE RAMIFICACION Y ACOTACION
        Y RAMIFICACION Y ACOTACION CON SUBESTIMACION"""
...
"""Marcos: graph_search sin la lista cerrada"""
...
def depth_first_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, Stack())  # PILA


"Codigo marcos"
def ramificacionacotacion_first_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search_without_closed(problem, ramificacionacotacion())


def ramificacionacotacionconsubestimacion_first_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search_without_closed(problem, ramificacionacotacionconsubestimacion(problem))
"Codigo marcos"
...
class GPSProblem(Problem):
    ...
    "dado un nodo calcula la linea recta para calcular la heuristica"
